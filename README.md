...
*Управление из Home Assistant*
 ...
 2. Отслеживание состояния: Силы тока, Напряжения, Мощности, Энрегии, Состояния защиты;
...
*Особенности*
 ...
 - Защита срабатывает при превышении сумарного тока 16А или выход напряжения за диапазон 190-250V;
